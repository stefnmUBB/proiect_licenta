...
using LillyScan.FrontendXamarin.Droid.Camera;
    ...
    public class CameraPreviewRenderer : FrameLayout, IVisualElementRenderer, IViewRenderer
    {
        ...
        void OnElementChanged(ElementChangedEventArgs<CameraPreview> e)
        {
            ...
            if (e.NewElement != null)
            {
                ...
                newFragment.CapturePeeked += CameraFragment_CapturePeeked;
                if (cameraFragment != null)
                    cameraFragment.CapturePeeked -= CameraFragment_CapturePeeked;
            }
        ...
        private void CameraFragment_CapturePeeked(byte[] imageBytes)
        {
            Console.WriteLine("CameraFragment_CapturePeeked");
            Element.HandleCapture(imageBytes);
        }
