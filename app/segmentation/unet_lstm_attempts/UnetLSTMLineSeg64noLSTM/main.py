# C:\Users\Stefan\miniconda3\envs\kaggle\python.exe D:\Public\CNNLSTMLineSeg64noLSTM\main.py
...
def main():   
    ...
    def create_segmentation_model():
        ...
        x = tf.keras.layers.Reshape((4,128))(x)    
    ...
    def callback_plot(epoch, logs):
        if epoch % 1 == 0:
            ...
            plt.savefig(f"D:\Public\CNNLSTMLineSeg64noLSTM\\figures\\ctc_{epoch}_{logs['loss']}.png")
            plt.close()       
            
        
        if epoch % 2 == 0:                
            #save_opt(train_model, "D:\\Public\\CNNLSTMFullPage\\train_model_0")
            model.save("D:\Public\CNNLSTMLineSeg64noLSTM\\train_model_0")
