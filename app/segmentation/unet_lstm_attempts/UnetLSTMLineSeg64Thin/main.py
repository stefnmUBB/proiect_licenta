# C:\Users\Stefan\miniconda3\envs\kaggle\python.exe D:\Public\CNNLSTMLineSeg64Thin\main.py
...
def main():       
    ...
    #for x,y in list(itertools.islice(ds,0,10)):     
    ...
    def callback_plot(epoch, logs):
        if epoch % 1 == 0:
            ...
            plt.savefig(f"D:\\Public\\CNNLSTMLineSeg64Thin\\figures\\ctc_{epoch}_{logs['loss']}.png")
            plt.close()       
            
        
        if epoch % 2 == 0:                
            #save_opt(train_model, "D:\\Public\\CNNLSTMFullPage\\train_model_0")
            model.save("D:\\Public\\CNNLSTMLineSeg64Thin\\train_model_0")
