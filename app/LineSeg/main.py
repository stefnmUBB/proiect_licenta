...
def main():   
    ...
    test_ds = enumerate_datasets([("D:\\Users\\Stefan\\Datasets\\hw_flex\\LineSeg\\test", None)], IMG_SIZE)
    test_ds = dataset_generator(test_ds, IMG_SIZE, POLY_LEN, PTS_LEN, augment)    
